...
"
" For this, the custom.vim, theme, this is defined as
...
let s:airline_a_normal   = [ '#00005f' , '#dfff00' , 232 , 246 ]
let s:airline_b_normal   = [ '#ffffff' , '#444444' , 251 , 238 ]
let s:airline_c_normal   = [ '#9cffd3' , '#202020' , 246 , 234 ]
...
let g:airline#themes#custom#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 186     , 234      , ''     ] ,
      \ }


"let s:airline_a_insert = [ '#00005f' , '#00dfff' , 232 , 186  ]
let s:airline_a_insert = [ '#00005f' , '#00dfff' , 148 , 148  ]
let s:airline_b_insert = [ '#ffffff' , '#005fff' , 251 , 238  ]
let s:airline_c_insert = [ '#ffffff' , '#000080' , 246 , 234  ]
